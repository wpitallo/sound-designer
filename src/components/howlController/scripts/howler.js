/*! @license
 *  howler.js v2.0.15 | howlerjs.com | (c) 2013-2018, James Simpson of GoldFire Studios | goldfirestudios.com | MIT License
 *  This version of howler has been modified and minified by zefie using uglify-js v3.x
 *  See https://loops.planeptune.org/geshi/source/howler.patch.txt for modifications
 */
...
(function() {
  ...
  HowlerGlobal.prototype = {
    ...
    _enableMobileAudio: function() {
      ...
      var isMobile = /iPhone|iPad|iPod|Android|BlackBerry|BB10|Silk|Mobi|Chrome/i.test(
  ...
  var Howl = function(o) {
    ...
    if (
      ((!o.src || o.src.length === 0) &&
        (!o.arraybuffer ||
          !(o.arraybuffer instanceof ArrayBuffer) ||
          !o.contenttype)) ||
      (o.html5 && !o.src)
    ) {
      console.error(
        "An array of source files, or an ArrayBuffer+ContentType, must be passed with any new Howl. Also, ArrayBuffer+ContentType are incompatible with html5 mode."
      );
      return;
    }
  ...
  Howl.prototype = {
    ...
    _ended: function(sound) {
      ...
      if (self._webAudio && loop) {
        ...
        console.log(
          "howler: end timer fired. playtime was " +
          currpos +
          "ms, expected " +
          wanted +
          "ms (" +
