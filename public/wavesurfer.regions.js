          ...
          var Region =
            ...
            (function() {
              function Region(params, ws) {
                ...
                this.marginTop = "0px";
                var channelCount = this.wavesurfer.backend.ac.destination
                  .channelCount;
                ...
                },
                {
                  ...
                  value: function bindDragEvents() {
                    ...
                    var edgeScroll = function edgeScroll(e) {
                      ...
                      var scrollLeft =
                        _this5.wrapper.scrollLeft +
                        scrollSpeed * scrollDirection;
                      _this5.wrapper.scrollLeft = scrollLeft = Math.min(
                        maxScroll,
                        Math.max(0, scrollLeft)
                      ); // Get the currently selected time according to the mouse position

                      var time = _this5.wavesurfer.regions.util.getRegionSnapToGridValue(
                        _this5.wavesurfer.drawer.handleEvent(e) * duration
                      );
                      ...
                      drag
                        ? _this5.onDrag(delta)
                        : _this5.onResize(delta, resize); // Repeat
                    ...
                    var onDown = function onDown(e) {
                      ...
                      startTime = _this5.wavesurfer.regions.util.getRegionSnapToGridValue(
                        _this5.wavesurfer.drawer.handleEvent(e, true) * duration
                      ); // Store for scroll calculations

                      maxScroll =
                        _this5.wrapper.scrollWidth - _this5.wrapper.clientWidth;
                    ...
                    var onMove = function onMove(e) {
                      ...
                      if (
                        _this5.scroll &&
                        container.clientWidth < _this5.wrapper.scrollWidth
                      ) {
                        if (drag) {
            ...
            (function() {
              ...
              function RegionsPlugin(params, ws) {
                ...
                this.util = _objectSpread({}, ws.util, {
                  getRegionSnapToGridValue: function getRegionSnapToGridValue(
                    value
                  ) {
                ...
                },
                {
                  ...
                  value: function enableDragSelection(params) {
                    ...
                    var edgeScroll = function edgeScroll(e) {
                      ...
                      var scrollLeft =
                        _this9.wrapper.scrollLeft +
                        scrollSpeed * scrollDirection;
                      _this9.wrapper.scrollLeft = scrollLeft = Math.min(
                        maxScroll,
                        Math.max(0, scrollLeft)
                      ); // Update range
                    ...
                    var eventDown = function eventDown(e) {
                      ...
                      maxScroll =
                        _this9.wrapper.scrollWidth - _this9.wrapper.clientWidth;
                    ...
                    this.on("disable-drag-selection", function() {
                      _this9.wrapper.removeEventListener(
                        "touchstart",
                        eventDown
                      );
                    ...
                    var eventMove = function eventMove(e) {
                      ...
                      var startUpdate = _this9.wavesurfer.regions.util.getRegionSnapToGridValue(
                        start * duration
                      );

                      var endUpdate = _this9.wavesurfer.regions.util.getRegionSnapToGridValue(
                        end * duration
                      );
                      ...
                      if (
                        scroll &&
                        container.clientWidth < _this9.wrapper.scrollWidth
                      ) {
